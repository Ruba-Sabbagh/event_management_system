...
use App\Http\Controllers\Auth\UsernameGetLinkController;
...
Route::middleware('guest')->group(function () {
    ...
    Route::get('forgot-username', [UsernameGetLinkController::class, 'create'])
    ->name('username.request');

    Route::post('forgot-username', [UsernameGetLinkController::class, 'store'])
                ->name('username.email');
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('logout', [AuthLoginController::class, 'destroy'])
                ->name('logout');
});
    });
