<div class="left-side-bar">
    <div class="brand-logo">
        <a href="index.html">
            <img src="/back/vendors/images/slogo.png" alt="" class="dark-logo" />
            <img
                src="/back/vendors/images/slogo.png"
                alt=""
                class="light-logo"
            />
        </a>
            ...
            <ul id="accordion-menu">
                <li>
                    <a href="/dashboard" class="dropdown-toggle no-arrow">
                        ...
                        ><span class="mtext">{{ __('svu.dashboard')}}</span>
                    </a>
                </li>
                <li class="dropdown">
                    <a href="javascript:;" class="dropdown-toggle">
                        <span class="micon bi bi-textarea-resize"></span
                        ><span class="mtext">{{ __('svu.programs')}}</span>
                    </a>
                    <ul class="submenu">
                        <li><a href="{{ route('allprograms') }}">{{ __('svu.add_pro') }}</a></li>
                        <li>
