...
@section('content')
                ...
                @foreach($nicknames as $nickname)
                    <tr>
                            ...
                            <td>
                                ...
                                @include('pages.nicknames2.modal.show')
                            </td>
                            <td>
                                <a href="#" data-toggle="modal" data-target="#ModalEdit{{ $nickname->id }}" class="btn btn-success btn-sm">{{ __('svu.edit') }}</a>
                                @include('pages.nicknames2.modal.edit')
                            </td>
                            <td>
                                {!! Form::open(['method' => 'DELETE','route' => ['nicknames2.destroy', $nickname->id],'style'=>'display:inline']) !!}
    ...
    @include('pages.nicknames2.modal.create')
